...
import celebrations from "../components/images/celebrations.gif";
import games from "../components/images/games.gif";
import positive from "../components/images/positive.gif";
import learning from "../components/images/learning.gif";
import growth from "../components/images/growth.gif";
import paid_leaves from "../components/images/paid_leaves.gif";
import emp_first from "../components/images/employee-first.gif";
import training from "../components/images/flexible-working-hours.gif";
    ...
    <>
     <div className="career-heading">
      ...
      <div className="container mx-auto">
        ...
        >
          <div className="container-circle carrer-hide-img mx-auto">
        ...
        <div className="row row-cols-1 row-cols-md-3 g-2 ms-2 me-5 d-flex justify-content-center mt-5 pb-2">
          ...
          <div className="circle-container">
            ...
            <p style={{ marginTop: "50%" }}>Mission</p>
          </div>
